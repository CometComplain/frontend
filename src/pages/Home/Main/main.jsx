...
const ActualHome = () => {
    ...
    return (
        <div id="home" className="flex flex-row items-start justify-between p-10 bg-gray-200" >
            <div className="flex flex-col w-1/2 gap-4">
                ...
                <button className="p-3 text-base font-semibold text-white bg-orange-600 rounded hover:shadow-md hover:shadow-orange-300 w-fit" >Register your Grievance</button>
            </div>
            <img src="/public/assests/hero-banner.png" alt="" width={300} height={300} className="mr-12" />
        </div>
    );
}
